...
from anaforge._bootstrap import ensure_paths  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        for law in discover_product_laws(REPO / "anaforge"):
            ...
            require_law(
                ...
                law_id=str(law.get("id") or "ana_law"),
        ...
        return 1
    tr = subprocess.run(
        [sys.executable, "-m", "pytest", str(REPO / "tests" / "test_anaforge_laws.py"), "-q"],
        cwd=str(REPO),
        check=False,
    )
